...
# API CALL FUNCTION
# -----------------------------
def get_timetable(iata_code: str, flight_type="departure"):
    params = {
        "key": API_KEY,
        "iataCode": iata_code,
        "type": flight_type
...
def process_airports(iata_list):
    ...
    for iata in iata_list:
        ...
        for flight in flights:
            ...
            minimal["key"] = f"{minimal['departure_scheduledTime']}_{minimal['departure_iataCode']}_{minimal['flight_iataNumber']}"
...
for round_num in range(1, MAX_RETRY_ROUNDS + 1):
    ...
    all_clean_departure_flights.extend(flights)
...
print(f"\nTotal flights processed: {len(all_clean_departure_flights)}")

# SAVE TO NEON DB
save_departure_flights(all_clean_departure_flights)
